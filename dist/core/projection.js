 ...
 */
export function buildLocalBasis(viewPlaneNormal, viewUp) {
 ...
 */
export function projectPointTo2D(point, anchor, basis) {
 ...
 */
export function toCanvasCoord(point, canvasWidth, canvasHeight, scale) {
 ...
 */
export function projectSegments(segments3D, anchor, basis, canvasWidth, canvasHeight, scale) {
