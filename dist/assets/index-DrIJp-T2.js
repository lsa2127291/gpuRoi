(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function t(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(n){if(n.ep)return;n.ep=!0;const r=t(n);fetch(n.href,r)}})();let x=null,T=!1;async function W(){if(T)return x;if(T=!0,typeof navigator>"u"||!navigator.gpu)return null;try{const s=await navigator.gpu.requestAdapter();return s?(x=await s.requestDevice(),x.lost.then(e=>{console.warn("WebGPU device lost:",e.message),x=null,T=!1}),x):null}catch{return null}}function A(s,e){return s[0]*e[0]+s[1]*e[1]+s[2]*e[2]}function E(s,e){return[s[1]*e[2]-s[2]*e[1],s[2]*e[0]-s[0]*e[2],s[0]*e[1]-s[1]*e[0]]}function M(s,e){return[s[0]-e[0],s[1]-e[1],s[2]-e[2]]}function U(s){const e=Math.sqrt(s[0]*s[0]+s[1]*s[1]+s[2]*s[2]);return e<1e-10?[0,0,0]:[s[0]/e,s[1]/e,s[2]/e]}function H(s,e,t){return[s[0]+(e[0]-s[0])*t,s[1]+(e[1]-s[1])*t,s[2]+(e[2]-s[2])*t]}const m=1e-8;function L(s){const e=[1/0,1/0,1/0],t=[-1/0,-1/0,-1/0];for(let i=0;i<s.length;i+=3)for(let n=0;n<3;n++)s[i+n]<e[n]&&(e[n]=s[i+n]),s[i+n]>t[n]&&(t[n]=s[i+n]);return{min:e,max:t}}function z(s,e,t){let i=1/0,n=-1/0;for(let r=0;r<8;r++){const a=[r&1?t.max[0]:t.min[0],r&2?t.max[1]:t.min[1],r&4?t.max[2]:t.min[2]],o=A(s,M(a,e));o<i&&(i=o),o>n&&(n=o)}return i<=m&&n>=-m}function I(s,e){const t=e*3;return[s[t],s[t+1],s[t+2]]}function R(s,e,t){return A(e,M(s,t))}function Y(s,e,t){const{vertices:i,indices:n}=s,r=L(i);if(!z(e,t,r))return[];const a=[],o=n.length/3;for(let u=0;u<o;u++){const l=n[u*3],h=n[u*3+1],d=n[u*3+2],f=I(i,l),c=I(i,h),B=I(i,d),g=R(f,e,t),p=R(c,e,t),v=R(B,e,t),P=Math.abs(g)<=m,C=Math.abs(p)<=m,S=Math.abs(v)<=m;if(g>m&&p>m&&v>m||g<-m&&p<-m&&v<-m||P&&C&&S)continue;const y=[];_(f,c,g,p,y),_(c,B,p,v,y),_(B,f,v,g,y),P&&G(y,f),C&&G(y,c),S&&G(y,B),y.length>=2&&a.push({start:y[0],end:y[1]})}return a}function _(s,e,t,i,n){if(t>m&&i>m||t<-m&&i<-m||Math.abs(t)<=m&&Math.abs(i)<=m||Math.abs(t)<=m||Math.abs(i)<=m)return;const r=t/(t-i);G(n,H(s,e,r))}function G(s,e){for(const t of s){const i=t[0]-e[0],n=t[1]-e[1],r=t[2]-e[2];if(i*i+n*n+r*r<m*m)return}s.push(e)}const j=`struct Params {
  normal: vec3f,
  _pad0: f32,
  anchor: vec3f,
  _pad1: f32,
